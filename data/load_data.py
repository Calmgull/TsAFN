...
__all__ = ['TSAFNDataLoader']

logger = logging.getLogger('MSA')

class TSAFNDataset(Dataset):
...
def TSAFNDataLoader(args):

    datasets = {
        'train': TSAFNDataset(args, mode='train'),
        'valid': TSAFNDataset(args, mode='valid'),
        'test': TSAFNDataset(args, mode='test')
    }
