        ...
        tmp = {
            ...
            'datasetParas':{
                'mosi':{
                    ...
                    # feature subNets
                    'a_lstm_hidden_size': 57,
                    'v_lstm_hidden_size': 53,
                    'a_lstm_layers': 1,
                    'v_lstm_layers': 1,
                    'text_out': 768,
                    'audio_out': 301,
                ...
                'mosei':{
                    ...
                    'learning_rate_video': 1e-5,  # -4
                    'learning_rate_other': 1e-5,  # -3
                    'weight_decay_bert': 0.001,
                    'weight_decay_audio': 0.0,
                    'weight_decay_video': 0.0,
                    'weight_decay_other': 0.01,
                    # feature subNets
                    'a_lstm_hidden_size': 34,
                    'v_lstm_hidden_size': 39,
                    'a_lstm_layers': 1,
                    'v_lstm_layers': 1,
                    'text_out': 768,
                    'audio_out': 143,
